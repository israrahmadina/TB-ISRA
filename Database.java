...
public class Database {
    ...
    static final String DB_URL = "jdbc:mysql://localhost/tbpboikan";
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            ...
            String sql = "INSERT INTO jual (no_faktur, nama, no_hp, alamat) VALUE ('%s', '%s', '%s', '%s' )";
            sql = String.format(sql, nomorFaktur, namaPelanggan, nomorHp, alamat);
            stmt.execute(sql);

            System.out.print("Masukkan  Struk: ");
    ...
    static void showData() {
        ...
        try {
            ...
            System.out.println("+--------------------------------+");
            System.out.println("|    DATA PELANGGAN DI RESTO   |");
            System.out.println("+--------------------------------+");
    ...
    static void deleteData() {
        try {
            ...
            // buat query hapus
            String sql = String.format("DELETE FROM jual WHERE no_faktur='%s'", no_faktur);
